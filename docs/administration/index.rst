...
Das Admin-Interface wird nach der Installation benötigt, um den Titel und die URI auf der :doc:`Website <site>` zu ändern, um die :doc:`Benutzer und Gruppe <users>` zu konfigurieren, um die Verbindung zu :doc:`OAuth Anbietern <allauth>` zu konfigurieren und die mit der API genutzten :doc:`Tokens <tokens>` zu ändern.
