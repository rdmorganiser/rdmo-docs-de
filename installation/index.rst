...
Verwende nicht den ``root`` Benutzer, um RDMO auszuführen! Es ist generell eine schlechte Idee  und viele Installationsschritte würden nciht funktionieren. ``sudo`` wird während der Installation verwendet, wenn root-Privilegien nötig sind, um Pakete zu isntalliren.
